...
class Lab6Part1Test {
	...
	void wolfSuperclassTest() {
		...
		Wolf wolf = new Wolf(wolfName, wolfAge);
		assertTrue(wolf.getClass().getSuperclass().toString().equals("class lab6part1.Animal"), "Testing that the Animal class is the super class of Wolf");
	}
	...
	void parrotSuperclassTest() {
		...
		assertEquals("class lab6part1.Animal", parrot.getClass().getSuperclass().toString(), "Testing that the Animal class is the super class of Parrot");
	...
	void Meattest() {
		...
		assertEquals("class lab6part1.Food", meat.getClass().getSuperclass().toString(), "Testing that the Food class is the super class of Meat");
	}
	...
	void Planttest() {
		...
		assertEquals("class lab6part1.Food", plant.getClass().getSuperclass().toString(), "Testing that the Food class is the super class of Plant");
	}
}
