...
/*
    public static void testPart1a() {
        ...
        lab3part1.SmartCard card = new lab3part1.SmartCard("Anna Undergrad");
...
/*
    public static void testPart1c() {
        ...
        lab3part1.SmartCard card = new SmartCard("Dr. Bob Lecturer");
        card.setStaff(true);
        System.out.println("Is " + card.getOwner() + " staff? " + card.isStaff());
        System.out.println();
    }
*/
    ...
    */
    ...
    public static void testPart3() {
        ...
        SmartCard studentCard = new SmartCard("Bob");
        lock.swipeCard(studentCard);
        door.openDoor();
        SmartCard staffCard = new SmartCard("Dr Blob");
